...
'H[0] = 6A09E667 + 1BDC6F6F = 85E655D6 '
'H[1] = BB67AE85 + 86126910 = 417A1795 '
'H[2] = 3C6EF372 + F6F443F8 = 3363376A '
'H[3] = A54FF53A + BCFCE922 = 624CDE5C '
'H[4] = 510E527F + 25D2430A = 76E09589 '
'H[5] = 9B05688C + 2FC08F85 = CAC5F811 '
'H[6] = 1F83D9AB + ACC75916 = CC4B32C1 '
'H[7] = 5BE0CD19 + 962D8621 = F20E533A '
'============================================================== '
'Block Contents:'
' W[0] = 00000000'
' W[1] = 00000000'
...
'H[0] = 85E655D6 + 9EA7148B = 248D6A61 '
'H[1] = 417A1795 + 908C2123 = D20638B8 '
'H[2] = 3363376A + B25CEF29 = E5C02693 '
'H[3] = 624CDE5C + A9F181DD = 0C3E6039 '
'H[4] = 76E09589 + 2C5C4ED0 = A33CE459 '
'H[5] = CAC5F811 + 9A392956 = 64FF2167 '
'H[6] = CC4B32C1 + 2AA1BB13 = F6ECEDD4 '
'H[7] = F20E533A + 27CCB387 = 19DB06C1 '
'Message Digest is '
'248D6A61 D20638B8 '
...
// var print_W = function (W) {
//     var s = "Block Contents:";
//     for (var i = 0; i < 16; i++) {
//         s += "\n  W[" + i + "] = " + verificatum.util.uint32ToHex(W[i]);
//     }
//     process.stdout.write(s + "\n");
// };

// var print_a_h_header = function () {
//     s = "          ";
//     s += "A        B        C        D        E        F        G        H";
//     process.stdout.write(s);
// };

// var print_a_h = function (i, a, b, c, d, e, f, g, h) {
//     var s = "\nt =";
//     if (i < 10) {
//         s += " ";
//     }
//     s += "" + i + ":";
//     s += " " + verificatum.util.uint32ToHex(a);
//     s += " " + verificatum.util.uint32ToHex(b);
//     s += " " + verificatum.util.uint32ToHex(c);
//     s += " " + verificatum.util.uint32ToHex(d);
//     s += " " + verificatum.util.uint32ToHex(e);
//     s += " " + verificatum.util.uint32ToHex(f);
//     s += " " + verificatum.util.uint32ToHex(g);
//     s += " " + verificatum.util.uint32ToHex(h);
//     process.stdout.write(s);
// };

// var print_H = function (H, Hold, a, b, c, d, e, f, g, h) {
//     var s = "";
//     s += "\nH[0] = " +
//         verificatum.util.uint32ToHex(Hold[0]) + " + " +
//         verificatum.util.uint32ToHex(a) + " = " +
//         verificatum.util.uint32ToHex(H[0]);
//     s += "\nH[1] = " +
//         verificatum.util.uint32ToHex(Hold[1]) + " + " +
//         verificatum.util.uint32ToHex(b) + " = " +
//         verificatum.util.uint32ToHex(H[1]);
//     s += "\nH[2] = " +
//         verificatum.util.uint32ToHex(Hold[2]) + " + " +
//         verificatum.util.uint32ToHex(c) + " = " +
//         verificatum.util.uint32ToHex(H[2]);
//     s += "\nH[3] = " +
//         verificatum.util.uint32ToHex(Hold[3]) + " + " +
//         verificatum.util.uint32ToHex(d) + " = " +
//         verificatum.util.uint32ToHex(H[3]);
//     s += "\nH[4] = " +
//         verificatum.util.uint32ToHex(Hold[4]) + " + " +
//         verificatum.util.uint32ToHex(e) + " = " +
//         verificatum.util.uint32ToHex(H[4]);
//     s += "\nH[5] = " +
//         verificatum.util.uint32ToHex(Hold[5]) + " + " +
//         verificatum.util.uint32ToHex(f) + " = " +
//         verificatum.util.uint32ToHex(H[5]);
//     s += "\nH[6] = " +
//         verificatum.util.uint32ToHex(Hold[6]) + " + " +
//         verificatum.util.uint32ToHex(g) + " = " +
//         verificatum.util.uint32ToHex(H[6]);
//     s += "\nH[7] = " +
//         verificatum.util.uint32ToHex(Hold[7]) + " + " +
//         verificatum.util.uint32ToHex(h) + " = " +
//         verificatum.util.uint32ToHex(H[7]) + "\n";
//     process.stdout.write(s);
// };
